...
** Interactions with =interprogram-paste-function=

If you modify =interprogram-paste-function=, you should to enable
=org-rich-yank= *after* doing so, or at least call
=org-rich-yank-enable= again after modifying
=interprogram-paste-function=, e.g.

#+begin_src emacs-lisp
  (setq interprogram-paste-function #'my-gui-paste-function)
  (require 'org-rich-yank)
  (org-rich-yank-enable)
#+end_src

This ensures you get support for links from Firefox and LibreOffice,
and avoids spurious links when pasting from other programs.
